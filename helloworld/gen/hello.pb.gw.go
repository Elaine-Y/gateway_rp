...
var (
	pattern_Hello_GetKey_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"v3", "pay", "transactions", "out-trade-no", "out_trade_no"}, "", runtime.AssumeColonVerbOpt(true)))
)
